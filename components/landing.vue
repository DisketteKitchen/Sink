<template>
  ...
  <div class="logo">
    <picture class="object-center">
      <source srcset="/assets/images/superwide.svg" media="(max-width: 200px)">
      <source srcset="/assets/images/stack.svg" media="(max-width: 1200px)">
      <img src="/assets/images/superwide.svg" alt="Diskette Kitchen" style="width:auto;">
    </picture>
    <a class="object-center" href="https://diskettekitchen.com">
      <ActionButton title="Home" class="watch-btn"/>
    </a>
  </div>
</template>
